...
class AmazonScraper {
    constructor({
        ...
        this.geo = geo;
        this.cookie = 'i18n-prefs=USD; ubid-main=131-5375616-1951139; aws-target-data=%7B%22support%22%3A%221%22%7D; regStatus=pre-register; aws-target-visitor-id=1713534149602-818750.44_0; lc-main=en_US; s_vnum=2153750686245%26vn%3D1; s_nr=1721750698098-New; s_dslv=1721750698098; x-main="@xeoUnLsREzjlcfXCACKVioO8J1Em5ZWOJ0NOthE4I?GPTJwFClBmoMihUeNv@q5"; at-main=Atza|IwEBIKlPcBaVRLMATb0rRAyAdhhcmbBMHYir9H95Ew5NzWxxELeiNI4Fakq-jam7EC4Bq9Mjyzy32ORK1VAe2mPO-rJqDCKQw1K6ZGWS5929O6AjoIjCy1arHhJ_9GEnZ2XjrCRwd0kP76xllJAchU13aL56CzpbGzJAwlH5rEdfmr6ImHDpXRC_WPkcKlOfdiKo2mEtvhrDl1qMwkoeWXW347k5; sess-at-main="WHfYBWKJ83fNz7Otpbmzot564oVMV6fBwCl8zo8Xt8g="; sst-main=Sst1|PQHYxTfx8h8gkj76OvkdkiBRCQhR1dWJOvfByHtxRiwbE1tdqk78bit-rIDBCe5Qi_jLUm4r5x2GAIr9Qml95lKDISpW3PuaDxS4ZEYYxR2OV6WMj5GMjXOMbPW82EUCKa2w7-OPQQkxY-AfWiPGKfCztqSjErALQjD6kAGfARYhSkRnhWGs9X6g05ZBSXklw0drj2jumlO_Dhoz8QSyVSngZKamBFdHGd13x_-RloWIn_hF3yXOkF8Voyipr9w1Gn3BzG3A_Pxf7sp6l-GNmUK1Nuq3JJQJHO1hk1U8eT_x-0k; AMCV_7742037254C95E840A4C98A6%40AdobeOrg=1585540135%7CMCIDTS%7C19942%7CMCMID%7C68080674659788205251041750889592020363%7CMCAAMLH-1723558394%7C4%7CMCAAMB-1723558394%7CRKhpRz8krg2tLO6pguXWp5olkAcUniQYPHaMWWgdJ3xzPWQmdj0y%7CMCOPTOUT-1722960794s%7CNONE%7CMCAID%7CNONE%7CvVersion%7C4.4.0; ubid-acbus=130-6756609-8453900; s_pers=%20s_fid%3D26F6427C8530C859-367687CDF3FADC86%7C1880722440181%3B%20s_dl%3D1%7C1722957840182%3B%20gpv_page%3DUS%253ASD%253ASOA-home%7C1722957840182%3B%20s_ev15%3D%255B%255B%2527SCSOAlogin%2527%252C%25271722956040183%2527%255D%255D%7C1880722440183%3B; session-id=140-2944844-5282938; session-id-time=2082787201l; skin=noskin; session-token=; csm-hit=tb:DXENG4GTYB8Y5ZQKPWRG+s-BDVFDDA68111H5T1TYEK|1723554246454&t:1723554246454&adb:adblk_no';
        this.bulk = bulk;
        ...
        try {
            for (let id of this.geo.product_information.id) {
                ...
                if (informationSection[0]) {
                    ...
                    let arr = informationSection[0].children; // All li
                        ...
                        if (len === 1) {
                            try {
                                ...
                                if(id === '#productDetails_detailBullets_sections1') {
                                    let aux = item.children[1].children[0].data
                                    if(aux){
                                      key = item.children[1].children[0].data;
                                      value = item.children[2].children[0].data; 
                                    }
                                }
                                else{
                                    key = item.children[0].children[0].data.trim();
                            ...
                            try {
                                if (id === '#detailBullets_feature_div > ul') {
                                    key = item.children[0].children[1].children[0].data.replace(/[\u200E\u200F:]*/g, "");	
                                    value = item.children[0].children[3].children[0].data;	
                                }
                                else{
    ...
    grabProduct(body, p) {
        const $ = cheerio.load(body.replace(/\s\s+/g, '').replace(/\n/g, ''));        
        let productList = $('div[data-index][data-component-type="s-search-result"]');
        ...
        for (let i = 0; i < productList.length; i++) {
            ...
            const index = productList[i].attribs['data-index'];
            
            
            
            let sponsored = $(`div[data-index=${index}] a.puis-sponsored-label-text`);

            if (!asin || sponsored.length > 0) {
                continue;
            }
